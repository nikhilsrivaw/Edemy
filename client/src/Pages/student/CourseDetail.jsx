  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        {/* right columm */}
        <div className=' max-w-[424px]  z-10  shadow-md shadow-red-400/40  rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] '>
          ...
          <div className='p-5'>
            <div className='flex items-center gap-2'>
              ...
              <img className='w-3.5' src={assets.time_left_clock_icon} alt="tiem left clock icon" />
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                ...
                <li>step-by-dtep , hands-on projects guidance</li>
