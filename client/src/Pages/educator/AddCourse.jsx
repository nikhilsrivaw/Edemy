    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      ...
      <form className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div>
          ...
          <div ref={editorRef} className='quill-editor h-40 mt-2 mb-4 border border-gray-500 rounded'></div>
        </div>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture , lectureIndex)=>(
                    <div key = {lectureIndex} className='felx justify-between items-center mb-2' >
                      ...
                      <img onClick={()=> handleLectures('remove' , chapter.chapterId , lectureIndex)} className='cursor-pointer' src={assets.cross_icon} alt="" />

                    </div>
                  ))}
                  <div className='inline-flex bg-gray-200 p-2 rounded cursor-pointer mt-2 ' onClick={()=> handleLectures('add' , chapter.chapterId)} > + Add Lectures</div>
                </div>
              )}
